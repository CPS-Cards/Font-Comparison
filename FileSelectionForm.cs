...
namespace Font_Comparison
{
    public partial class FileSelectionForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //This will be pointing to the csv
            if (!textBox1.Text.Contains(".txt"))
                MessageBox.Show($"File {textBox1} is not a txt file.");
            if(!File.Exists(textBox1.Text))
                MessageBox.Show($"File {textBox1} does not exist.");
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Couldn't create lists.");
                }
            }
        }
